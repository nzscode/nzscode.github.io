...
addCopyButton("dicts_to_list_copy");
addCopyButton("dicts_to_pdf_copy");
addCopyButton("dicts_to_csv_key,value_copy");
addCopyButton("dicts_to_csv_fields_to_values_copy");
addCopyButton("dicts_to_html_copy");
addCopyButton("dicts_to_json_full_dict_copy");
addCopyButton("dicts_to_json_itemized_copy");
